...
| --- | --- | --- | --- |
| INV-01 | P1: Admin Envia Convite | Tasks | Pending |
| INV-02 | P1: Admin Envia Convite | Tasks | Pending |
| INV-03 | P1: Convidado Aceita Convite | Tasks | Pending |
| INV-04 | P1: Convidado Aceita Convite | Tasks | Pending |
| INV-05 | P1: Admin Lista Usuários e Convites | Tasks | Pending |
| INV-06 | P1: Admin Cancela Convite Pendente | Tasks | Pending |
| INV-07 | Edge Cases: token/security/concurrency | Tasks | Pending |
