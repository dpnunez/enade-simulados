...
export const env = createEnv({
  server: {
    ...
    PASSWORD_RESET_EMAIL_DELIVERY: z.enum(["console", "smtp"]).default("console"),
    PASSWORD_RESET_EMAIL_FROM: z.string().min(1).default("noreply@enade.local"),
    PASSWORD_RESET_EMAIL_LOG_DIR: optionalTrimmedString,
    PASSWORD_RESET_EMAIL_LOG_FILE_NAME: optionalTrimmedString,
