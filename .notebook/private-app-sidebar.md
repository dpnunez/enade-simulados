...
- The private shell header exposes the logged-in area with the visible label `Área logada`; E2E tests should assert this current contract instead of the older `Sessão ativa` wording.
