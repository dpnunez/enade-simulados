...
- [env-config](env-config.md) — NEXT_PUBLIC_URL is canonical app URL; DB uses DATABASE_URL | pattern | env, auth, db
...
- [student-simulated-exams](student-simulated-exams.md) — Student attempt generation, correction, history + safe in-progress DTOs | flow | simulated-exams, prisma, e2e
